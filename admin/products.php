...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <h3>adauga produs</h3>
      <input type="text" required placeholder="Nume produs" name="name" maxlength="100" class="box">
      <input type="number" min="0" max="9999999999" required placeholder="Pret" name="price" onkeypress="if(this.value.length == 10) return false;" class="box">
...
<section class="show-products" style="padding-top: 0;">
   ...
   <div class="box">
      ...
      <div class="flex">
         <div class="price"><?= $fetch_products['price']; ?><span>lei</span><span>/-</span></div>
         <div class="category"><?= $fetch_products['category']; ?></div>
      </div>
      <div class="name"><?= $fetch_products['name']; ?></div>
      <div class="flex-btn">
         <a href="update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">actualizeaza</a>
